---
{"dg-publish":true,"permalink":"/how-to-develop-a-super-power-memory/","tags":["memory","memory/major-system","memory/harry-lorayne"],"created":"2026-04-16T16:34:27.728-04:00","updated":"2026-04-27T20:43:37.746-04:00"}
---
...
A person's name is his most prized possession, and there is nothing more pleasing to him than hearing his own name or having it remembered by others. — location: 1156 

</div></div>


[[MEMORIA - Arquiteto Mental.pdf]]

# Fatos

Memória está diretamente ligado a atenção. Quão mais interessante algo for, mais fácil será de lembrar. O segredo é tornar o que deseja memorizar em algo interessante.

Apesar de ser uma faca de dois gumes, acreditar ser capaz de lembrar algo ajudará a lembrar. Opostamente, o ato de anotar é justamente para não esquecer o que prejudica o lembrar. A memória é delegada ao papel aio invés de nosso cérebro.

Memória funciona como um músculo. Quanto mais se usa mais fácil se torna.

A memória treinada é baseada em imagens mentais.

Lembrar de algo desconectado e sem referência é muito difícil, por isso é sempre importante associar com algo que já é de seu conhecimento.

# Imagens Mentais

As imagens mentais devem ser ridículas, bizarras, fora do padrão, absurdas. Desta maneira é mais fácil de recordar posteriormente.

Os pensamentos são materializados em conceitos usando palavras. O importante é visualizar mentalmente as imagens mentais ao invés de pensar nas palavras.

Como tornar as imagens bizarras:

- Tamanhos desproporcionais
- Quantidades absurdas
- Violência
- Vergonha
- Trocas ilógicas (calçar um chapéu)

# Método de Ligação

Criei uma associação bizarra entre dois items para formar um link mental. Visualize mentalmente a bizarra conexão.

Listas podem ser facilmente memorizada ao criar links entre item 1 e 2, então 2 e 3, e assim por diante. Desta maneira você poderá navegar para frente ou para trás poderá lembrar a lista inteira a partir de qualquer item.

# Método Para Números

Conhecido como *Peg System*, ou *Major System*.

A dificuldade de lembrar números é pelo fato que o número em si é um conceito abstrato não vinculado a nada.

Esse método requer palavras de apoio que representem números. As palavras de apoio serão usadas para realizar as associações e recordação posterior.

- **0** → *Z/S* - Zero
- **1** → *T ou D* - ambos possuem apenas uma linha vertical
- **2** → *N* - dois contatos com a linha base
- **3** → *M* - três contatos com a linha base
- **4** → *R* - do ingles fouR
- **5** → *L* - o numeral romano para 50 = L
- **6** → *J/SH/CH* - virando o J, lembra um 6
- **7** → *C/K* - o 7 são as pernas do K
- **8** → *F/V* - motor 8 válvulas
- **9** → *P/B* - P virado lembra 9

>[!important]
> *O que importa é o som da letra*.
> *Vogais são ignoradas*
> *WHY* - não são utilizadas

Método:

- Memorizar os sons para os 10 números
- Observe uma sequência de números e converta para letras
- Forme múltiplas palavras
- Associe as palavras
- Para lembrar faça o processo inverso.

**5346**
- 5 → L, 3 → M, 4 → R, 6 → SH
- LaMa RoCHa
- Eu gigante cruzando um campo de lama minúsculo, por que minhas pernas foram reduzidas a milímetros enquanto uma tempestade de rochas.

Apenas isso já ajuda na memorização de números, porém o método prove 100 palavras que representam 100 números seguindo a lógica do som. Dessa maneira não há necessidade de pensar em uma palavra para representar o número.

[[Major System - Português\|Major System - Português]]

O trabalho inicial é grande, porém depois de memorizar as 100 palavras, aqui adaptadas para o português. Ao ver números será facilmente traduzido em uma palavra que poderá ser associada.

Usando as palavras pre-memorizadas

- 53 → Lima
- 46 → Rocha
- Imagine esculpindo uma enorme rocha com uma lima do tamanho de uma unha.

As seguintes páginas podem ser usadas para aprender e treinar o reconhecimento de números e palavras.

- [[Major System - BR.html\|Major System - BR.html]]
- [[Major System.html\|Major System.html]]

**Telefones**

- Claire: um ser feérico da corte do inverno com seus cabelos negros formando ==chifres== que lembra os de um cervo. Ela se veste com uma ==pinup== gravida com uma barriga de ==pedra== (rock) porosa é ela bem ==mala== (LaMe).
- Chifres = Bezelbul → BeZeL (Memória verdadeira) → 905
- PiNuP = 929
- RocK = 47
- LaMe = 53
- 905 929 47 53

[[Memory - Telephone Numbers\|Memory - Telephone Numbers]]
...
- 9 99 95 72 31
	...
	- 72 - cano
	- 31 - mata
	- ==Sapo== usando a lingua para inpinar uma ==pipa== gigantesca que tira ele do chão mas ele segura com as patas ==peludas== que dão no em baixo de um ==cano== no meio da ==mata==.

# Pessoas

Prestar atenção é fundamental para lembrar de algo. Ao encontrar com alguém observe e note o maior número de detalhes possíveis do rosto da pessoas. Imagine que você será questionado a fazer um retrato falado em uma investigação criminal de alta importância.
...
**Exercício:** Gaste alguns instante observando o rosto de alguém então feche os olhos e tente recordar o maior número de detalhes. Então abra os olhos e confira o quanto você conseguir recordar.

*Nota*: o mesmo exercício pode ser usado para qualquer coisa.

A razão pela qual esquecemos os nomes de pessoas é porque de fato não prestamos atenção quando ouvimos. Quando perguntar o nome de alguém foque em ouvir o que a pessoa irá dizer. Caso não tenha ouvido ou entendido, pergunte novamente ou repita para ter certeza. Durante a conversa use o nome da pessoa o maior números de vezes para re-enforçar a memória.

A técnica de Palavras Substitutas podem ser usadas para nomes complicados ou mesmo sobrenomes incomuns.

- Mr. Freedman → Um homem sendo frito no óleo
	- Fry - Free
- O fato de buscar uma alternativa ou uma associação já é um esforço de interesse.

Associe a percepção do rosto com o nome

- Mulher, cabelos brancos e longos, mais alta, óculos retangulares de cor azul, blusa decotada.
- Nome Moyra.
- Ving Tsun MOY feito de vinhas brancas e o M usa um óculos azul

Também é possível associar a nova pessoa com outra com o meso nome.

# Datas

Dias da semana inicia em 1 (segunda) termina em 7 (domingo)

- Terapia na Quarta feira as 4:30 da tarde
	- 3 ; 4 → 34 → MAR
		- Me afundando em um ==mar== de lágrimas durante uma sessão de terapia.
	- 3 ; 16 ; 30 → soma ; tchau ; mesa
		- A ==soma== de todos os ==tchaus== que dou em terapia não cabe em uma ==mesa==.

A memória natural se encarrega de lembrar os minutos. A lógica também é importante, não faz sentido fazer terapia as 4 da manhã.

O mesmo sistema pode ser usado para compromisso unícos

- dia 22 as 1600. nenê ; tchau
	- Uma mão gigante com ==bebes== mordendo dos dedos enquanto da ==tchau==.

# Palavras Sem Significado

A dificuldade de aprender idiomas está ligado ao vocabulário que é abstrato e a pronuncia. Para memorizar a o significado, crie uma associação entre a palavra estrangeira e o significado. Para o som use **palavras substitutas**.

**Palavras Substitutas**
Pense em algo, palavra ou frase, conhecida que assemelhe com a pronuncia desejada.
- Fenetre (frances, janela) → Fan-ate-raw (english)
- A memória natural tomará conta de lembrar o detalhe

# Destruição

Para saber se um item já foi escolhido, destrua a associação em sua mente. Se você memorizou Banana, quando destruí-la imagine apenas a casca. É importante que você reforme a associação em sua mente com o item destruído.

- Saber qual carta do baralho foi escolhida
- Saber qual itens da lista do mercado ja foram escolhidos

# Reforço

Se não usar o sistema ele não funciona.

Após algum tempo de ter memorizado algo, faça o exercício de recordar. Após fazer isso algumas vezes a memória estará solidificada.

# Outros

*Memorizar discurso*
- Crie links entre os tópicos a serem abordados.
- Para cada tópico expand para memorizar palavras chaves.

*Cartas de Baralho*
Cada carta é formada por uma letra, inicial do naipe, e a palavra de apoio referente ao número.
- 2 de copas = C N → CoNe, CaNo, CaNa
- Mantenha a ordem das cartas sem na mesma ordem de número e naipes
- Destrua cartas selecionadas/removidas.

*Perda*
- Não lembrar onde colocou algo ocorre pela falta de atenção. Preste atenção em sua ação ao invés de realizar no automático.
- Crie uma associação entre o local e o objeto.

*Esquecimento*
- Visualize um local real que surgirá antes de sair.
- Associe o local com o que não pode esquecer.
	- Maçaneta feita de guarda chuva que ao abrir a porta abre e te empurra como um airbag
- 
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/atomic-habits/#point-call" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
There are a set of beliefs and assumptions that shape the system, an identity behind the habits. — location: 466 
...
When I started coaching trampoline, at the end of one of my classes, my boss asked me what the names of the children that attend it are. I drew a blank and looked stupid for not knowing. Then she asked me to try to remember at least one name per class. Guess what, I started putting effort into remembering their names, and in just a few classes, I had memorized all the names. Despite the good intentions of my boss, I felt that I wasn't doing my best at work, so that prompted me to change ASAP.
...
People often think that sticking to good habits and avoiding temptation requires a lot of willpower. However, research proves that individuals with good habits are simply better at avoiding temptation. So, make the good ones visible and hide the temptations.
...
Forming a habit requires repeated action. It's not about how long you do something; it's about how often you do it.
...
When the reason is bigger than the obstacles, you will find a way.
